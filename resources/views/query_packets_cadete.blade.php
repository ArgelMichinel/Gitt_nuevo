...
@section('inc_head')
    ...
    <script type="text/javascript" language="javascript" src="{{ asset('JS/query_packets_client2.js') }}"></script>
...
@section('output')
    ...
    <div class="table_container" style="padding-bottom: 40px;">
        ...
        <x-tabla_query_cadete :packets="$packets" :clients="$clients"></x-tabla_query_cadete>
